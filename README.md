...
I specialize in end-to-end data processing, exploratory data analysis (EDA), predictive modeling, and data cleaning using Python and modern data analytics tools.
